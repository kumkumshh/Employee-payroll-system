...
public class Main {
    public static void main(String[] args) {
        ...
        FullTimeEmployee emp3 = new FullTimeEmployee("John Doe", 103, 5000.0);
        FullTimeEmployee emp4= new FullTimeEmployee("John Doe", 104, 5000.0);
        FullTimeEmployee emp5= new FullTimeEmployee("John Doe", 105, 5000.0);
